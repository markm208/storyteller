 ...
 */
class Comment {
    constructor(displayCommentEvent, developerGroupId, timestamp, commentText, selectedCodeText, selectedCodeBlocks, imageURLs, videoURLs, audioURLs, id) {
        ...
        this.selectedCodeText = selectedCodeText;
